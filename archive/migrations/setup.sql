...
-- Drop all functions
DROP FUNCTION IF EXISTS create_app_admin_role() CASCADE;
DROP FUNCTION IF EXISTS create_indexes() CASCADE;
DROP FUNCTION IF EXISTS create_policies() CASCADE;
...
DROP FUNCTION IF EXISTS has_system_role(user_id UUID) CASCADE;
...
-- Create App_Admin role function
